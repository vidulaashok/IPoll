...
function hasFilledfields()
{
	if(document.getElementById('name').value.length!=0&&document.getElementById('surName').value.length!=0&&
			...
			document.getElementById('userPhoto').value.length!=0&&document.getElementById('currState').value.length!=0
...
<div class="main">
	...
	<s:form action="regVoterId.action" method="post" enctype="multipart/form-data" onsubmit="return verifyForm()">
		<tr>
			<td colspan="2"><div id="error" class="error">${requestScope.error}</div></td>
		</tr>
		<s:textfield name="name" id="name" label="Name " />
		<s:textfield name="surName" id="surName" label="Surname " />
		<tr>
		...
		<s:textfield label="Father's name" id="fName" name="fName"  />
		<tr>
		...
		<s:textfield label="Ward NO " name="curWardNo" id="curWardNo" />
		<s:textfield label="Father's/Wife's id " id="relId" name="relId" />
